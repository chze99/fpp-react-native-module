...
export default function FacialRecognitionSettingScreen({ navigation }) {
    ...
    //List of facial data 
    const [rcAttributeAndOcclusionMode, setrcAttributeAndOcclusionMode] = useState(1);
    ...
    const [FaceBlurThreshold, setFaceBlurThreshold] = useState(0.70);
    const [FaceLowBrightnessThreshold, setFaceLowBrightnessThreshold] = useState(70.0);
    const [FaceHighBrightnessThreshold, setFaceHighBrightnessThreshold] = useState(220.0);
    const [FaceBrightnessSTDThreshold, setFaceBrightnessSTDThreshold] = useState(60.0);
    const [FaceFaceMinThreshold, setFaceFaceMinThreshold] = useState(100);
    const [FaceRcAttributeAndOcclusionMode, setFaceRcAttributeAndOcclusionMode] = useState(2);
    const [isLoading, setisLoading] = useState(true);
    const [warning, setWarning] = useState({ "rcAttributeAndOcclusionMode": false })
        ...
        try {
            ...
            if (parameters) {
                setrcAttributeAndOcclusionMode(parameters.rcAttributeAndOcclusionMode),
                    ...
                    setFaceHighBrightnessThreshold(parameters.FaceHighBrightnessThreshold),
                    ...
                    setFaceRcAttributeAndOcclusionMode(parameters.FaceRcAttributeAndOcclusionMode)
            }
            ...
            <ScrollView style={styles.scrollView}>
                ...
                <View style={{ flexDirection: "column", display: "flex", marginLeft: 5 }}>
                        ...
                        <TextInput
                            ...
                            onChangeText={text => {
                                ...
                                if (validateInt(0, 5, text)) {
                                    warningHandler(warning, setWarning, "rcAttributeAndOcclusionMode", false)
                                } else {
                                    warningHandler(warning, setWarning, "rcAttributeAndOcclusionMode", true)
                                }
                            }
                            }

                            value={rcAttributeAndOcclusionMode.toString() != "NaN" ? rcAttributeAndOcclusionMode.toString() : ""}
                    ...
                    <View style={styles.inputFieldView}>
                        ...
                        <TextInput
                            editable
                            onChangeText={text => sethighBrightnessThreshold(parseFloat(text))}
                    ...
                    <View style={styles.inputFieldView}>
                        ...
                        <RadioButtons values={smile_enabled} onPress={onSmileEnable} defaults={smileEnabled ? 0 : 1} />
                    </View>
                    <View style={styles.inputFieldView}>
                        <Text style={styles.titleTextView}>Max Face Enabled</Text>
                        <RadioButtons values={maxface_enabled} onPress={onMaxFaceEnable} defaults={maxFaceEnabled ? 0 : 1} />
                    </View>
                    <View style={styles.inputFieldView}>
                    ...
                    <View style={styles.inputFieldView}>
                        ...
                        <TextInput
                            editable
                            onChangeText={text => setFaceLowBrightnessThreshold(parseFloat(text))}
                    ...
                    <View style={styles.inputFieldView}>
                        ...
                        <TextInput
                            editable
                            onChangeText={text => setFaceHighBrightnessThreshold(parseFloat(text))}
                    ...
                    <View style={styles.inputFieldView}>
                        ...
                        <TextInput
                            editable
                            onChangeText={text => setFaceBrightnessSTDThreshold(parseFloat(text))}
                    ...
                    <View style={styles.inputFieldView}>
                        <Text style={styles.titleTextView}>FaceRcAttributeAndOcclusionMode</Text>
                        <TextInput
                            editable
                            onChangeText={text => setFaceRcAttributeAndOcclusionMode(parseInt(text))}
                    ...
                    <View style={{ paddingHorizontal: 20, paddingTop: 50, paddingBottom: 10, justifyContent: "space-between", flexDirection: "row", display: "flex" }} >
...
const styles = StyleSheet.create({
    ...
    warningView: {
        flex: 2, alignSelf: 'center', color: 'red'
    },
    inputFieldView: {
        display: 'flex', flexDirection: 'row', marginBottom: 10
    },
    titleTextView: {
        flex: 3, marginRight: 8, alignSelf: 'center'
    },
    textInputView: {
        flex: 1, marginRight: 8, justifyContent: 'center', borderWidth: 1, paddingLeft: 2
    },
    hintView: {
