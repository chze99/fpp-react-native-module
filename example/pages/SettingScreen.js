  ...
  return isLoading ? (
    ...
    <View style={{ flexDirection: 'column', display: 'flex' }}>
      ...
      <RadioButtons
        ...
        onPress={onCameraDirection}
        defaults={cameraFacingFront ? 0 : 1}
      />
      <Text>Camera Rotation</Text>
      <RadioButtons
        values={camera_rotation}
        onPress={onCameraRotation}
        defaults={
      ...
      <RadioButtons
        values={face_rotation}
        onPress={onFaceRotation}
        defaults={
          faceRotation == 0
            ? 0
            : faceRotation == 90
      ...
      <RadioButtons
        values={screen_cross}
        onPress={onScreenCross}
        defaults={isCross ? 0 : 1}
      />
      <Text>Use IR</Text>
      <RadioButtons
        values={use_ir}
      ...
      <RadioButtons
        values={use_ir_preview}
        onPress={onUseIrPreview}
        defaults={useIRPreview ? 0 : 1}
      />
      <View
        style={{
