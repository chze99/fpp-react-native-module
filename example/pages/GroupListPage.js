    ...
    return (
        <View>
            <FlatList
                ...
                renderItem={
                    ({ item }) =>
                        <View style={{ display: 'flex', flexDirection: 'row', marginHorizontal: 50, marginVertical: 10 }}>
                            <Text style={{ flex: 2, alignSelf: 'center' }} >{item}</Text>
                            <TouchableOpacity style={styles.button} onPress={() => { navigation.navigate("GroupListFacePage",{name:item}) }}>
